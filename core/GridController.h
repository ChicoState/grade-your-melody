...
public:
    ...
    Q_INVOKABLE void setNote(int beat, int row, int acc);     // clears beat first, then sets
    ...
    // grading
    Q_INVOKABLE void setExpectedRow(int beat, int row, int acc); // row -1 means "should be empty"
